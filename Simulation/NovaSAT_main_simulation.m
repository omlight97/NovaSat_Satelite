...
figure
subplot(3,3,1)
    plot(SimData.Time_vec/60 ,phi_vec * 180/ pi)
    title('\phi^\circ in time')
    xlabel('time[sec]')
    ylabel('Angle[\circ]')
    grid on
subplot(3,3,2)
    plot(SimData.Time_vec/60 ,Theta_vec * 180/pi)
    ...
    grid on
subplot(3,3,3)
    plot(SimData.Time_vec/60 ,psi_vec * 180 / pi)
    ...
    grid on
subplot(3,3,4)
    plot(SimData.Time_vec/60 ,P_data * 180 / pi)
    ...
    grid on
subplot(3,3,5)
    plot(SimData.Time_vec/60 ,Q_data * 180 / pi)
...
subplot(3,3,6)
    plot(SimData.Time_vec/60 ,R_data * 180 / pi)
