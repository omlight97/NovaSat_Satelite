function [Next_Angular_State,Attitude_Control_Data,Flags] = Nova_Attitude_Prop(States,Current_Step_Angular,Flags,Params)
% TODO:
% add state finder function logic to know what turn to make 
...
%         if(isLOS2Sun)
        ...
        %         end
        %     else
        %         rotate_theta_to_45 -> rotate_psi_to_psi0_plus_360
        %             if(isLOS2Sun)
        %             else rotate_theta_to_-45 -> rotate_psi_to_psi0_plus_360
        %                 if(isLOS2Sun)
        %                 end
        % end
        end
